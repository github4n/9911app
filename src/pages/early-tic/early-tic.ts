...
/**
 * Generated class for the EarlyTicPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-early-tic',
  templateUrl: 'early-tic.html',
})
export class EarlyTicPage {
  ...
  goTo(page)
  {
    this.navCtrl.push('EarlyTicDetailPage',{ page: page });
  }
